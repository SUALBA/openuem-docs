...
If you want to update a server, just select the servers that you want to update, either by clicking on the checkbox next to the server’s name or by clicking on the **Select All** button, selecting the release from the dropdown menu and clicking on the **Update** button.
...
:::note
If you’re connected to the console, you may lose connection for a while, please be patient till the services are restarted
:::
